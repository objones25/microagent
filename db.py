...
_SEED_PROMPT_FILES: list[str] = ["v1", "v2", "v2.1", "v2.2", "v2.3", "v2.4", "v2.5", "v2.6", "v2.7", "v2.8"]
_SEED_EVAL_PROMPT_FILES: list[str] = ["eval-v1", "eval-v1.1", "eval-v1.2", "eval-v1.3", "eval-v1.4"]
